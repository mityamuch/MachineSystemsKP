# Домашнее задание: Проектирование ML-системы — Задание 13
...
13. **Динамическое ценообразование для райдшеринга:** Спроектируйте систему для прогнозирования спроса и предложения для установки пиковых цен. Сосредоточьтесь на прогнозировании временных рядов и обновлениях в реальном времени.
...
- Задержка (latency) ответа не должна превышать **177 мс**.
- Система должна обслуживать **2,432,132 активных пользователей в день (DAU)**, с пиковой нагрузкой в **10,670 запросов в секунду (RPS)**.
